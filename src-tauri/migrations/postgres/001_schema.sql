...
CREATE TABLE projects (
    ...
    grid_unit_mm    DOUBLE PRECISION NOT NULL DEFAULT 2.5,
    folder_path     TEXT,
...
CREATE TABLE symbol_definitions (
    ...
    name            TEXT NOT NULL,
    svg_path        TEXT,
    width_grid      DOUBLE PRECISION NOT NULL DEFAULT 4,
    height_grid     DOUBLE PRECISION NOT NULL DEFAULT 4
);
...
CREATE TABLE symbol_placements (
    ...
    show_cross_ref BOOLEAN NOT NULL DEFAULT TRUE
);
...
CREATE TABLE busbar_sizes (
    ...
    cross_section_mm2 DOUBLE PRECISION NOT NULL,
    label           TEXT NOT NULL,              -- '100×10'
    din_43671_code  TEXT,                       -- '100x10'
    is_din_standard BOOLEAN NOT NULL DEFAULT FALSE
);
...
CREATE TABLE busbar_ratings (
    ...
    ambient_temp_c  INTEGER NOT NULL DEFAULT 35,
    frequency_hz    INTEGER NOT NULL DEFAULT 50,
    icw_ka          DOUBLE PRECISION,
    icw_duration_s  DOUBLE PRECISION DEFAULT 1.0,
    mounting        TEXT,
